...
readonly class DatabaseTest
{
    ...
    /**
     * В идеале надо бы проверять типы данных полей в БД, но реализовал простой парсинг строки т.к. не увидел в задаче подобного требования.
     *
     * @throws Exception
     */
    public function testBuildQuery(): void
    {
        ...
        $results[] = $this->db->buildQuery('SELECT name FROM users WHERE user_id = 1'); // Здесь не придумал как делать проверку на тип данных
